/*
  cap19_IsingSeq.c: MC simulation for an Ising model on a generic graph, with sequential update.
...
void oneSweepSeq(int *s, graphStruct *pGraph, float *prob);

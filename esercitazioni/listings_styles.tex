...
\else% else
%
%imposto il font per lo stile typewriter (si possono anche indicare le variani, i.e. italic, bold, bolditalic)
\setmonofont[Scale=0.85,
...
% breaklines=true,                 % sets automatic line breaking
  ...
  commentstyle=\itshape\color{verdeoliva},    % comment style
